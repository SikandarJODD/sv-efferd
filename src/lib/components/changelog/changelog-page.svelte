...
<section class="mx-auto w-full max-w-3xl pb-16 sm:pb-20">
	<div class="relative border-x border-border/80">
		...
		<div class="relative px-5 py-10 sm:px-8 sm:py-14 md:px-12 md:py-8">
			<StripedPattern class="mask-[radial-gradient(400px_circle_at_right,white,transparent)] opacity-20" />
			<div class="mx-auto max-w-2xl">
				<h1 class="text-3xl font-medium tracking-tight sm:text-3xl">{changelogPageData.title}</h1>
				<p
